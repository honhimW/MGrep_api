...
class ChemoDatabase(db.Model):
    ...
    mg = db.Column(db.String(200))
    zs2 = db.Column(db.String(200))
    panle575 = db.Column(db.String(200))
...
class ChemoReport(db.Model):
    ...
    is_send_lims = db.Column(db.String(20), default="未推送")  # 是否已推送lims系统
